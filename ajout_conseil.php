...
$code_classe=mysqli_fetch_array(mysqli_query($link,"select codecl from classe where nom='$nomcl' and promotion='$promo'"));
$codecl=$code_classe['codecl'];


$compte=mysqli_fetch_array(mysqli_query($link,"select count(*) as nb from conseil where numsem='$semestre' and codecl='$codecl'"));
if($compte['nb']>0){
?>
...
mysqli_query($link,"insert into conseil(numsem,codecl) values ('$semestre','$codecl')");
/*
