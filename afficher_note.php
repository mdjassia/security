...
<form method="post" action="afficher_note.php" class="formulaire">
   <FIELDSET>
 <LEGEND align=top>Mati�res �tudi�e<LEGEND>  <pre>
   <p>
   <?php
   $i=1;
