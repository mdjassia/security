...
$id=$_GET['modif_el'];
$ligne=mysqli_fetch_array(mysqli_query($link,"select * from eleve,classe where eleve.codecl=classe.codecl and numel='$id'"));
...
if(isset($_POST['adresse'])){
	if($_POST['date']!="" and $_POST['adresse']!="" and $_POST['phone']!=""){
		...
		mysqli_query($link,"update eleve set date_naissance='$date', adresse='$adresse', telephone='$phone' where numel='$id'");
...
$id=$_GET['supp_el'];
mysqli_query($link,"delete from eleve where numel='$id'");
mysqli_query($link,"delete from evaluation where numel='$id'");/*	Supprimier tous les entres en relation		*/
mysqli_query($link,"delete from stage where numel='$id'");
mysqli_query($link,"delete from bulletin where numel='$id'");
