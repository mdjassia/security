...
if($compte['nb']>0){
?>
<SCRIPT LANGUAGE="Javascript">alert("erreur! Ce prof existe d�ja ");</SCRIPT>
<?php
}
else{
mysqli_query($link,"insert into prof(nom,prenom,adresse,telephone) values('$nom','$prenom','$adresse','$telephone')");
...
echo '<br/><a href="ajout_prof.php">Revenir � la page pr�c�dente !</a>';
}
else {
 ?>
