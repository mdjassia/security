...
$id=$_GET['modif_dip'];
$ligne=mysqli_fetch_array(mysqli_query($link,"select * from eleve,classe,eleve_diplome,diplome where eleve.numel=eleve_diplome.numel and classe.codecl=eleve.codecl and diplome.numdip=eleve_diplome.numdip and id='$id'"));
...
Nom et pr�nom          :         <?php echo $ligne['nomel'].' '.$ligne['prenomel']; ?><br/>
...
Ann�e d'obtention        :       <input type="text" name="ann_obt" value="<?php echo $ligne['annee_obtention']; ?>"><br/>
<input type="hidden" name="id" value="<?php echo $id; ?>">
<center><input type="image" src="modifier.png"></center>
</form>
<br/><br/><a href="listeEtudiant.php?nomcl=<?php echo $ligne['nom']; ?>">Revenir � la page pr�c�dente !</a>
...
if(isset($_POST['titre'])){
	if($_POST['titre']!="" and $_POST['note']!="" and $_POST['etabli']!="" and $_POST['lieu']!="" and $_POST['ann_obt']!=""){
		...
		mysqli_query($link,"update eleve_diplome set numdip='$numdip', lieu='$lieu', etablissement='$etabli', commentaire='$comment', note='$note', annee_obtention='$annee' where id='$id'");
	...
	echo '<a href="modif_diplome.php?modif_dip='.$id.'">Revenir � la page precedente !</a>';
}
if(isset($_GET['supp_dip'])){
$id=$_GET['supp_dip'];
mysqli_query($link,"delete from eleve_diplome where id='$id'");
