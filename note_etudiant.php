...
$data=mysqli_query($link,"select bulletin.numel,nomel,prenomel,nommat,numsem,promotion,notefinal,nom from matiere,bulletin,eleve,classe where classe.codecl=eleve.codecl and bulletin.numel=eleve.numel and matiere.codemat=bulletin.codemat and eleve.numel='$id' order by numsem");
?>
<div class="corp">
...
<th class="rounded-q2">Mati�re</th>
