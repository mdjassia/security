...
$matiere=mysqli_query($link,"select matiere.codemat,nommat from enseignement,matiere where enseignement.codemat=matiere.codemat and enseignement.codecl=(select codecl from classe where nom='$nomcl' and promotion='$promo') and numsem='$semestre'");
...
?>
<FIELDSET>
 <LEGEND align=top> Mati�res �tudi�es </LEGEND>  
...
<br/><br/><a href="afficher_bulettin.php">Revenir � la page precedente !</a>
</form>
