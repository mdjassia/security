...
$compte=mysqli_fetch_array(mysqli_query($link,"select count(*) as nb from classe where nom='$nomcl' and promotion='$promo'"));
$bool=true;
if($compte['nb']>0){
$bool=false;
...
if($bool==true){
mysqli_query($link,"insert into classe(nom,numprofcoord,promotion) values ('$nomcl','$numprof','$promo')");
...
$data=mysqli_query($link,"select numprof,nom from prof");//select pour les promotions
 ?>
