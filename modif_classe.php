...
$ligne=mysqli_fetch_array(mysqli_query($link,"select codecl,classe.nom as nomcl,promotion,numprofcoord,prof.nom,prenom from classe,prof where numprof=numprofcoord and codecl='$id'"));
$promo=mysqli_query($link,"select distinct promotion from classe");
...
$id=$_GET['supp_classe'];
mysqli_query($link,"delete from classe where codecl='$id'");
